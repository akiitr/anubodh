...
title: CPU
---
The Central Processing Unit ([[CPU]]) is the primary control and computation engine in a modern [[SoC]]. Instead of designing a [[CPU]] from scratch, teams license pre-designed, pre-verified IP cores (e.g., from Arm or the RISC-V ecosystem). The specification process involves selecting and meticulously configuring a core to precisely fit the application's [[PPA]] requirements.
...
*   **[[Microarchitecture]] Configuration**: Tuning the core's internal structure for performance and power.
    ...
    *   **Cache Subsystem**: Specifying size, associativity, and line size for L1 I-Cache, L1 D-Cache, and the L2 cache.
